DFM_Locale = 
{
	...
	["ERROR_SYNC_NOT_ENABLED"]						= "|cff0066d1%s|r : You need to enable sync to send a sync request",
...
function DFM_InitializeLocales()
	...
	if DFM_Lang == "frFR" then
		...
		DFM_Locale.ERROR_SYNC_NOT_ENABLED							= "|cff0066d1%s|r : Vous devez activer la synchronisation pour envoyer une requête"
